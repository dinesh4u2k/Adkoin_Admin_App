            ...
            mUploadTask = fileReference.putFile(mImageUri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            Upload upload = new Upload(mTag.getText().toString().trim(),mEditTextFileName.getText().toString().trim(),mCost.getText().toString().trim(),
                            ...
                            cost=Integer.valueOf(mCost.getText().toString());
                            new Mytask().execute();
                            Log.d(TAG, url +""+name);
...
//                            startActivity(i);
    ...
    private void openImagesActivity(){
        ...
        intent.putExtra("Cost", mCost.getText().toString());
